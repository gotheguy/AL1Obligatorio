...
public class Tests {
	...
	public void testListarCrucerosRankingAsc() {
		s.crearSistemaReservas(4);
		assertEquals(Retorno.Resultado.ERROR_1, s.listarCrucerosRankingAsc("Tarariras").resultado);
		s.registrarCiudad("Montevideo");
		s.registrarCrucero("Montevideo", "Cru2", 5, 2);
		s.ingresarComentario("Montevideo", "Cru2", "Biennn!",4);
		s.registrarCrucero("Montevideo", "Cru1", 5, 2);
	...
	public void testListarCrucerosRanking() {
		...
		s.crearSistemaReservas(4);
		s.registrarCiudad("Montevideo");
		s.registrarCiudad("Melo");
		s.registrarCiudad("Trinidad");
		s.registrarCrucero("Montevideo", "Cru2", 5, 2);
		s.ingresarComentario("Montevideo", "Cru2", "Biennn!",4);
		s.registrarCrucero("Melo", "Cru1", 5, 2);
		s.ingresarComentario("Melo", "Cru1", "Espantoso!",1);
		s.registrarCrucero("Trinidad", "Cru3", 5, 2);
		s.ingresarComentario("Trinidad", "Cru3", "Esselllente!!",5);
		s.registrarCrucero("Melo", "Cru4", 5, 2); 
		s.ingresarComentario("Melo", "Cru4", "Maomeno!",3);
	...
	public void testListarComentarios() {
		s.crearSistemaReservas(4);
		assertEquals(Retorno.Resultado.ERROR_2, s.listarComentarios("Montevideo", "Cru2").resultado);
		s.registrarCiudad("Montevideo");
		assertEquals(Retorno.Resultado.ERROR_1, s.listarComentarios("Montevideo", "Cru2").resultado);
		s.registrarCiudad("Montevideo");
		s.registrarCrucero("Montevideo", "Cru2", 5, 2);
		s.ingresarComentario("Montevideo", "Cru2", "Maomeno!",3);
		s.ingresarComentario("Montevideo", "Cru2", "Esselllente!!",5);
		s.ingresarComentario("Montevideo", "Cru2", "Espantoso!",1);
		s.ingresarComentario("Montevideo", "Cru2", "Biennn!",4);
		
		r = s.listarComentarios("Montevideo", "Cru2");
		assertEquals(Retorno.Resultado.OK, r.resultado);
	...
	public void testCargarDistancias() {
		...
		assertEquals(Retorno.Resultado.OK,s.cargarDistancias(new int[][] {
			{0,10,25,15,30,0},
			{10,0,20,0,0,0},
			{25,20,0,0,0,40},
			{15,0,0,0,0,45},
	...
	public void testBuscarCamino() {
		...
		assertEquals(Retorno.Resultado.OK,s.buscarCamino(mat,"Montevideo","New York").resultado);
